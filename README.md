...
<a href="https://play.google.com/store/apps/details?id=com.voxon.sim">
...
#### Geoip and Geosite
- geoip.dat and geosite.dat files are in `Android/data/com.voxon.sim/files/assets` (path may differ on some Android device)
